...
<body>
    <h1>View Employee Tasks in charts</h1>
    ...
    <%
        ...
        if (userIdParam != null && !userIdParam.trim().isEmpty() && type != null && !type.trim().isEmpty()) {
            ...
            if (taskData.isEmpty()) {
                ...
                String[] darkColors = {"'rgba(255, 99, 132, 0.8)'", "'rgba(255, 159, 64, 0.8)'", "'rgba(255, 205, 86, 0.8)'", "'rgba(75, 192, 192, 0.8)'", "'rgba(54, 162, 235, 0.8)'", "'rgba(153, 102, 255, 0.8)'", "'rgba(201, 203, 207, 0.8)'"};
                int colorIndex = 0;
                ...
                for (Map<String, Object> dataPoint : taskData) {
                    ...
                    colors.append(darkColors[colorIndex % darkColors.length]).append(",");
                    colorIndex++;
                }
                if (labels.length() > 0) {
                    ...
                    var chart = new Chart(ctx, {
                        ...
                        options: {
                            ...
                            scales: {
                                y: {
                                    beginAtZero: true,
                                    min: 0 // Ensure y-axis starts at 0 and does not go below
                                }
                            }
                        }
                    });
